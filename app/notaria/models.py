...
class Kardex(models.Model):
    ...
    numminuta = models.CharField(max_length=100, blank=True, null=True)
...
class Contratantesxacto(models.Model):
    ...
    formulario = models.CharField(max_length=2, null=True, blank=True)
    monto = models.CharField(max_length=100, null=True, blank=True)
    opago = models.CharField(max_length=2, null=True, blank=True)
    ofondo = models.CharField(max_length=300, null=True, blank=True)
    montop = models.CharField(max_length=2, null=True, blank=True)
